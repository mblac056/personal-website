  ...
  return (
    ...
    >
      <section className="mb-6 max-w-4xl mx-auto">
        ...
        <p className="mb-4">I'm a web developer, project manager, barbershop harmony enthusiast, and trivia lover based in Fergus, Ontario, and working in nearby Guelph.</p>

          <p className="mb-4">Right now, I'm a Full Stack Developer with <a href="https://farmhealthguardian.com/" className="font-bold" target="_blank" rel="noopener noreferrer">Farm Health Guardian</a>, where I build digital tools that help strengthen biosecurity in the agri-food sector.</p>
